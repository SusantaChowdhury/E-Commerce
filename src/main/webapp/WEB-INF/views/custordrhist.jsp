                                                ...
                                                <div class="flex flex-col  justify-between items-center min-h-screen">
                                                    ...
                                                    <nav class="w-full bg-gray-900 text-gray-100 px-4 shadow">
                                                        <div class="flex flex-wrap justify-between items-center py-2">
                                                            <!-- Logo -->
                                                            <a href="customerhome"
                                                                class="flex m-2 items-center space-x-3">
                                                                            ...
                                                                            <% for(Orderhist x : op) { int
                                                                                ...
                                                                                <tr
                                                                                    ...
                                                                                    <td
                                                                                        ...
                                                                                        <div class="border-2 p-2 rounded-full <%= statusColor %>"><%= statusmessage %></div>
                                                                                    </td>

                                                                                    <!-- Action -->
                                                                                    <td class="py-3 px-4 text-center">
                                                                                        <% if
                                                                                            ("ongoing".equals(statusw))
                                                                                            { %>
                                                    ...
                                                    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                                                        <div class="sm:flex sm:items-center sm:justify-between">
                                                            ...
                                                            <ul
                                                                ...
                                                                <li>
                                                                    <a href="#"
                                                                        class="hover:underline me-4 md:me-6">Privacy
                                                                        Policy</a>
                                                                </li>
                                                                <li>
                                                                    <a href="#"
