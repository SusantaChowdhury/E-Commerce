                 ...
                 background-color: black; color: yellow; width: 1204px ">
                                            <section class="products">
                                                <% if(plist.isEmpty()){ %>
                                                    ...
                                                    <% }else{ for(Product x: plist) { String p_name=x.getName(); int
                                                        ...
                                                        <div class="product-card">
                                                            ...
                                                            <p class="extra-info">Remaining: <%=p_qty%>
                                                            </p>
                                                            <span class="price">₹<%=p_price%></span>
                                                            <div class="button-group">
                                                                <form action="Remprodperm" method="post">
                                                                    <input type="hidden" name="prodid"
                                                                        value="<%=p_id%>">
                                                                    <button type="submit"
                                                                        class="buy-now">Unapprove</button>
                                                                </form>
                                                            </div>
                                                        </div>
