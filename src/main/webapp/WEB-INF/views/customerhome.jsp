                            ...
                            <nav class="bg-gray-900 w-full text-gray-100 px-4 shadow-md">
                                <div class="flex flex-wrap justify-between items-center py-2">
                                    ...
                                    <div
                                        ...
                                        <a href="customerhome" class="text-cyan-400 font-medium border-b-2">Products</a>
                                        <a href="custcart" class="hover:text-cyan-400 transition">Cart</a>
                                        <a href="custordrhist" class="py-1 hover:text-cyan-400 font-medium">Orders</a>
                                        <!-- User Dropdown -->
                                        <div class="relative inline-block text-left mr-2">
                                            <button id="dropdownButton" onclick="toggleDropdown()"
                                                ...
                                                <% String[] nameParts=custname.trim().split(" "); String initials = ""; for (String part : nameParts) { if (!part.isEmpty()) initials += part.charAt(0); } initials = initials.toUpperCase(); %>
                                                    ...
                                                    border-white border-3 bg-cyan-400 text-gray-700 font-semibold
                                                    text-2xl">
                                                    <%= initials %>
                                        </div>
